...
namespace Testing.RETURN
{
    public partial class frmReturn_condition : Form
    {
        ...
        misc_class msc = new misc_class();
        public frmReturn_condition(string title, int penalty, string due)
        {
            InitializeComponent();
            _title = title;
            _due = due;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            ucReturn.condition = cmbcondition.Text;
            ucReturn.bmp = true;
            this.Close();
        }

        private void frmReturn_condition_Load(object sender, EventArgs e)
        {
            ...
            msc.condition_to_cmb(cmbcondition);
        }

        private void label8_Click(object sender, EventArgs e)
        {
            using (frmaddcondition frm = new frmaddcondition())
            {
                frm.ShowDialog();
            }
            msc.condition_to_cmb(cmbcondition);
